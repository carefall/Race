...
public class GameController :MonoBehaviour
{
	...
	public static ACC_CarController PlayerCar { get { return Instance.m_PlayerCar; } }
	public static bool RaceIsStarted { get { return true; } }
	public static bool RaceIsEnded { get { return false; } }

	ACC_CarController m_PlayerCar;
	List<ACC_CarController> Cars = new List<ACC_CarController>();
	...
	protected virtual void Awake ()
	{
		...
		Cars.AddRange (FindObjectsByType<ACC_CarController>(FindObjectsSortMode.None));
